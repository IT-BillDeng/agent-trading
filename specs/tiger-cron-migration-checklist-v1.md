...
> 前提：已完成 `tiger-engine-schema-v1.md` 与 `tiger-cron-redesign-v1.md`。
...
动作：
- 新建 `tiger-strategist-intraday-q15`
- 后续补高优先级事件唤醒逻辑
...
### 动作
1. 创建目录：
   - `runtime/tiger_engine/watcher/`
   - `runtime/tiger_engine/newswire/`
...
### 动作
1. 新建 `tiger-strategist-intraday-q15`
2. 输入先读取：

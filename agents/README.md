...
| Agent | 职责 | 频率 | 模型 |
|-------|------|------|------|
| watcher | 系统健康监控 | 每 15 分钟 | mimo-v2-omni |
| newswire | 新闻/催化扫描 | US 盘前 + 盘中 15min | mimo-v2-omni |
| strategist | 交易计划草案 | 信号触发或定时 | mimo-v2-pro |
| executor | 执行检查单/参数校验 | 策略完成后触发 | mimo-v2-omni |
| scout | 候选标的/异常波动扫描 | 按需或定时 | mimo-v2-omni |
| closer | 收盘总结/复盘/明日关注 | 每市场收盘后 | mimo-v2-omni |
...
| newswire | read, write, browser, web_search, web_fetch, sessions_send |
| strategist | read, write, sessions_send |

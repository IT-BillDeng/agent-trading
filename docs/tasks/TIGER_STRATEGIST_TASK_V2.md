...
- `runtime/tiger_engine/newswire/latest.json` — 盘前新闻
- `data/watchlist.json` — 标的白名单
- `runtime/tiger_engine/.last_execution_cycle.json`（如存在）
...
必须输出到 `runtime/tiger_engine/strategy_plan_latest.json`，格式如下：

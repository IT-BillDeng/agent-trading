...
class LegacyStrategyEngine:
    """Legacy heuristic strategy kept as a thin compatibility facade."""
    ...
    ) -> list[LegacyStrategySignal]:
        positions = positions or {}
        signals: list[LegacyStrategySignal] = []
...
def build_legacy_strategy_engine(app: AppConfig) -> LegacyStrategyEngine:
